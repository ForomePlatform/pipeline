...
int main(int argc,char** argv){
        ...
        {
                using namespace std;
                string infilename,trio_ID_filename,outfilename,X_choice;
                double PP_thresh,ExAC_thresh,AF_unrel_thresh;
                for(int i(0);i<argc;++i){
                ...
                cout<<"AF_unrel_thresh="<<AF_unrel_thresh<<"\n";

                ifstream fin(infilename.c_str());
                ofstream fout(outfilename.c_str());
                denovo_worker(fin,trio_ID_filename,fout,X_choice,PP_thresh,ExAC_thresh,AF_unrel_thresh);
        }
